...
export default function ProjectsMain() {
    return (
        <>
            <h4><a href="https://rodrigobrentano-annotations-maker.netlify.app" target="_blank" rel="noreferrer" >Annotations Maker</a></h4>
            <h4><a href="https://rodrigobrentano-currency-converter.netlify.app" target="_blank" rel="noreferrer" >Currency Converter</a></h4>
            ...
            <h4><a href="https://rodrigobrentano-text-case-converter.netlify.app/" target="_blank" rel="noreferrer" >Text Case Converter</a></h4>
